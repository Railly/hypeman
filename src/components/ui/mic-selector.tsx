    ...
    <DropdownMenu onOpenChange={handleDropdownOpenChange}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="sm"
          className={cn(
            "hover:bg-oklch(0.967 0.001 286.375) flex w-48 cursor-pointer items-center gap-1.5 dark:hover:bg-oklch(0.274 0.006 286.033)",
            className
          )}
        ...
        {devices.length > 0 && (
          <>
            ...
            <div className="flex items-center gap-2 p-2">
              ...
              <div className="bg-oklch(0.967 0.001 286.375) ml-auto w-16 overflow-hidden rounded-md p-1.5 dark:bg-oklch(0.274 0.006 286.033)">
                <LiveWaveform
