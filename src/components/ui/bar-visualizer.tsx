    ...
    return (
      <div
        ...
        className={cn(
          ...
          "bg-oklch(0.967 0.001 286.375) h-32 w-full overflow-hidden rounded-lg p-4 dark:bg-oklch(0.274 0.006 286.033)",
          className
        )}
        style={{
          ...style,
...
const Bar = React.memo<{
  ...
  <div
    ...
    className={cn(
      ...
      "rounded-full",
      "bg-oklch(0.92 0.004 286.32) data-[highlighted=true]:bg-oklch(0.21 0.006 285.885) dark:bg-oklch(1 0 0 / 10%) dark:data-[highlighted=true]:bg-oklch(0.92 0.004 286.32)",
      state === "speaking" && "bg-oklch(0.21 0.006 285.885) dark:bg-oklch(0.92 0.004 286.32)",
