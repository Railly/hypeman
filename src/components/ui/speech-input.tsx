...
function useSpeechInput() {
  ...
  if (!context) {
    throw new Error(
      "SpeechInput compound components must be used within a"
    )
  }
  return context
}
    ...
    return (
      <SpeechInputContext.Provider value={contextValue}>
        <div
          ref={ref}
          className={cn(
            "relative inline-flex items-center overflow-hidden rounded-lg border border-oklch(0.92 0.004 286.32) border-transparent transition-all duration-200 dark:border-oklch(1 0 0 / 10%)",
            scribe.isConnected
              ? "bg-oklch(1 0 0) dark:bg-oklch(0.967 0.001 286.375) border-oklch(0.92 0.004 286.32) shadow-sm dark:bg-oklch(0.141 0.005 285.823) dark:dark:bg-oklch(0.274 0.006 286.033) dark:border-oklch(1 0 0 / 15%)"
              : "",
            className
          )}
        >
...
>(function SpeechInputRecordButton(
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-oklch(0.21 0.006 285.885) absolute h-4 w-4 rounded-full transition-all duration-200 dark:bg-oklch(0.92 0.004 286.32)",
      ...
      <SquareIcon
        className={cn(
          "text-oklch(0.577 0.245 27.325) absolute h-4 w-4 fill-current transition-all duration-200 dark:text-oklch(0.704 0.191 22.216)",
    ...
    return (
      <div
        ...
        className={cn(
          ...
          showPlaceholder
            ? "text-oklch(0.552 0.016 285.938) italic dark:text-oklch(0.705 0.015 286.067)"
            : "text-oklch(0.552 0.016 285.938) [mask-image:linear-gradient(to_right,transparent,black_16px,black_calc(100%-16px),transparent)] dark:text-oklch(0.705 0.015 286.067)",
