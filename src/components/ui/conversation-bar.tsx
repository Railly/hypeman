...
>(
  (
    ...
    return (
      ...
      >
        <Card className="m-0 w-full gap-0 border border-oklch(0.92 0.004 286.32) p-0 shadow-lg dark:border-oklch(1 0 0 / 10%)">
              ...
              <div className="flex items-center justify-between gap-2 p-2">
                <div className="h-8 w-[120px] md:h-10">
                  <div
                    className={cn(
                      ...
                      "bg-oklch(0.141 0.005 285.823)/5 text-oklch(0.141 0.005 285.823)/70 dark:bg-oklch(0.985 0 0)/5 dark:text-oklch(0.985 0 0)/70"
                    )}
                  >
                      ...
                      >
                        ...
                        {agentState === "disconnected" && (
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-oklch(0.141 0.005 285.823)/50 text-[10px] font-medium dark:text-oklch(0.985 0 0)/50">
                              Customer Support
                            </span>
                          </div>
                        )}
                ...
                <div className="flex items-center">
                  <Button
                    ...
                    className={cn(isMuted ? "bg-oklch(0.141 0.005 285.823)/5 dark:bg-oklch(0.985 0 0)/5" : "")}
