...
export const AudioScrubber = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-oklch(0.21 0.006 285.885)/20 pointer-events-none absolute inset-y-0 left-0 dark:bg-oklch(0.92 0.004 286.32)/20"
        style={{ width: `${localProgress * 100}%` }}
      />

      <div
        className="bg-oklch(0.21 0.006 285.885) pointer-events-none absolute top-0 bottom-0 w-0.5 dark:bg-oklch(0.92 0.004 286.32)"
        style={{ left: `${localProgress * 100}%` }}
      />

      {showHandle && (
        <div
          className="border-oklch(1 0 0) bg-oklch(0.21 0.006 285.885) pointer-events-none absolute top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 shadow-lg transition-transform hover:scale-110 dark:border-oklch(0.141 0.005 285.823) dark:bg-oklch(0.92 0.004 286.32)"
          style={{ left: `${localProgress * 100}%` }}
        />
      )}
    </div>
