  ...
  return (
    <span
      ...
      className={cn(
        ...
        status === "spoken" && "text-oklch(0.141 0.005 285.823) dark:text-oklch(0.985 0 0)",
        status === "unspoken" && "text-oklch(0.552 0.016 285.938) dark:text-oklch(0.705 0.015 286.067)",
        status === "current" && "bg-oklch(0.21 0.006 285.885) text-oklch(0.985 0 0) dark:bg-oklch(0.92 0.004 286.32) dark:text-oklch(0.21 0.006 285.885)",
        className
      )}
      {...props}
    >
    ...
    >
      <div className="flex flex-1 flex-col gap-1">
        ...
        {showTimeLabels && (
          <div
            className={cn(
              "text-oklch(0.552 0.016 285.938) flex items-center justify-between text-xs dark:text-oklch(0.705 0.015 286.067)",
              labelsClassName
            )}
          >
