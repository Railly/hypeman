...
export const LiveWaveform = ({
  ...
  return (
    ...
    >
      {!active && !processing && (
        <div className="border-oklch(0.552 0.016 285.938)/20 absolute top-1/2 right-0 left-0 -translate-y-1/2 border-t-2 border-dotted dark:border-oklch(0.705 0.015 286.067)/20" />
      )}
      <canvas
